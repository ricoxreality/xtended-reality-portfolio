...
const PROJECT = {
  ...
  type: "Experimental",
  description:
    "What happens when Parisian haute couture collides with the neon-drenched underworld of Kamurocho?",
  shortDescription:
  ...
  photos: [
    {
      src: "/projects/yakuza/photo-1.jpg",
      alt: "YSL watch detail",
      caption: "Timepiece detail.",
    },
    {
      src: "/projects/yakuza/photo-2.jpg",
      alt: "Yakuza sword",
      caption: "Ancestral blade.",
    },
    {
      src: "/projects/yakuza/photo-3.png",
      alt: "Grillz detail",
      caption: "Ice and metal.",
    },
  ],
};
...
export default function YakuzaPage() {
  ...
  return (
    <div className="bg-[#0d0d0d] text-[#eeece6] min-h-screen">
      ...
      <NextProjectFooter currentProjectId="ysl-meets-yakuza" />
    </div>
  );
}
