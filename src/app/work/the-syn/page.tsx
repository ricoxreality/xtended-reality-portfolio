...
const PROJECT = {
  ...
  type: "Experimental",
  description:
    "A surreal exploration of dogma and devotion set against desolate, otherworldly landscapes.",
  shortDescription:
    "This concept short film visualizes a cryptic ritual unfolding in a barren wasteland. Combining striking color contrasts—vibrant crimson against muted greys—it delves into themes of blind faith and the monumental scale of ancient beliefs.",
  tags: ["Short Film", "Concept", "Cinematic"],
  thumbnailUrl: "/projects/the-syn/path.jpg",
  gifSrc: "/projects/the-syn/the-syn-gif.gif",
  fullVideoSrc: "/projects/the-syn/the-syn-video.mov",
  photos: [
    {
      src: "/projects/the-syn/horse.jpg",
      alt: "Red cloak and horse",
      caption: "The guide.",
    },
    {
      src: "/projects/the-syn/mask.jpg",
      alt: "Falling red mask",
      caption: "Shattered facade.",
    },
    {
      src: "/projects/the-syn/cult.jpg",
      alt: "Cult gathering",
      caption: "The congregation.",
    },
    {
      src: "/projects/the-syn/feet.jpg",
      alt: "Bare feet in mud",
      caption: "Grounding.",
    },
  ],
};
...
// ── Page ─────────────────────────────────────────────────────────────────────
export default function TheSynPage() {
  useLayoutEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="bg-[#0d0d0d] text-[#eeece6] min-h-screen">
      ...
      <NextProjectFooter currentProjectId="the-syn" />
    </div>
  );
}
