...
const PROJECT = {
  ...
  category: "Brand Film",
  year: "2025",
  type: "AI Visual Campaign",
  description:
    "A visceral portrait of human performance at its limit. We built a generative pipeline around real athletic energy — capturing the invisible milliseconds of pure power.",
  shortDescription:
    "This campaign explores the boundary between human physiology and machine perception. By capturing micro-movements and augmenting them through our proprietary AI models, we visualized speed not just as motion, but as raw energy.",
  tags: ["Brand Film", "AI Generation", "Slow Motion", "Athletic Performance"],
  thumbnailUrl: "/projects/nike/boxer-eyes.jpg",
  gifSrc: "/projects/nike/haro.gif",
  fullVideoSrc: "/projects/nike/hero.mov",
  photos: [
    {
      src: "/projects/nike/athlete-scream.jpg",
      alt: "Athlete with Nike sunglasses — pure intensity",
      caption: "The moment before everything releases.",
    },
    {
      src: "/projects/nike/starting-blocks.png",
      alt: "Nike sprint spikes on starting blocks",
      caption: "Position. Tension. Milliseconds.",
    },
    {
      src: "/projects/nike/athlete-shoulder.jpg",
      alt: "Nike apparel detail — sweat, light, texture",
      caption: "Detail that reads at 48fps.",
    },
  ],
};
...
// ── Page ─────────────────────────────────────────────────────────────────────
export default function NikeSpeedPage() {
  useLayoutEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="bg-[#0d0d0d] text-[#eeece6] min-h-screen">
      ...
      <NextProjectFooter currentProjectId="nike-speed" />
    </div>
  );
}
